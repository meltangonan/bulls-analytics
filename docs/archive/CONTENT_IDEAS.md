...
> **Superseded (2026-07):** this was the original court-first content playbook. The current north star is the board-first "Bulls visual encyclopedia" in `docs/bulls-content-playbook.html`. Kept for the format sketches and concept fragments.
