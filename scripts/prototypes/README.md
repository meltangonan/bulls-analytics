...
| `sophomore_game_scores.py` | Top fifteen Bulls sophomore games since 1983–84 by Game Score, the rookie post's pools, tiebreak and table; a sophomore is the second NBA season played (career histories), checked against NBA.com's Sophomore filter from 1996–97 and CommonAllPlayers; PTS, REB, AST before FG and 3PT, no +/- (untracked before 1996–97) | `tests/test_sophomore_game_scores.py` |
